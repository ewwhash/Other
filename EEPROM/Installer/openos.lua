...
lzss = load(request("https://raw.githubusercontent.com/ewwhash/Other/master/lzss.lua"), "=lzss.lua")()
print("Compressing...")

local compressed = lzss.getSXF(lzss.compress(request("https://raw.githubusercontent.com/ewwhash/Other/master/EEPROM/Installer/eeprom-minified.lua")
	:gsub(
		"%%(%w+)%%",
		{
			pass = password or "",
